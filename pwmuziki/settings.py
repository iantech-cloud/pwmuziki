...
# Email
# Use a Gmail App Password in production; console output remains the safe local default.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'hello@pwmuziki.local')
